    ...
    public void getChatMessage() throws Exception {
        ...
        StompSessionHandler handler = new TestSessionHandler(failure) {
            ...
            public void afterConnected(final StompSession session, StompHeaders connectedHeaders) {
                ...
                session.subscribe("/chat/send", new StompFrameHandler() {
                ...
                try {
                    ...
                    session.send("/app/receive", myMessage);
                } catch (Throwable t) {
                    failure.set(t);
                    latch.countDown();
                }
        ...
        // Step 1:  Simulate a connection - Fix the endpoint URL to match the configuration
